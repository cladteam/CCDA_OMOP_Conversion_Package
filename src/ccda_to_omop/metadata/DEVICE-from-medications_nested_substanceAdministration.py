...
metadata = {
    'DEVICE-from-medications_nested_substanceAdministration': {
    'root': {
        'config_type': 'ROOT',
        ...
        'element':
          ("./hl7:component/hl7:structuredBody/hl7:component/hl7:section"
           ...
           "/../hl7:entry/hl7:substanceAdministration/hl7:entryRelationship"
           "/hl7:substanceAdministration/hl7:consumable/hl7:manufacturedProduct/hl7:manufacturedMaterial")
    },
    ...
    'device_exposure_start_date_inner_substanceadmin_low': {
        'config_type': 'FIELD',
        'data_type': 'DATE',
    ...
    'device_exposure_start_date_outer_substanceadmin_low': {
        'config_type': 'FIELD',
        'data_type': 'DATE',
        'element': "../../../../../hl7:effectiveTime/hl7:low",
        'attribute': "value",
    ...
    'device_exposure_start_date_outer_substanceadmin_value': {
        'config_type': 'FIELD',
        'data_type': 'DATE',
    ...
    'device_exposure_start_datetime_inner_substanceadmin_low': {
        'config_type': 'FIELD',
    ...
    'device_exposure_start_datetime_outer_substanceadmin_low': {
        'config_type': 'FIELD',
        'data_type': 'DATETIME_LOW',
        'element': "../../../../../hl7:effectiveTime/hl7:low",
        'attribute': "value",
    ...
    'device_exposure_start_datetime_outer_substanceadmin_value': {
        'config_type': 'FIELD',
        'data_type': 'DATETIME_LOW',
        'element': "../../../../../hl7:effectiveTime",
        'attribute': "value",
    ...
    'device_exposure_end_date_inner_substanceadmin_high': {
        'config_type': 'FIELD',
        'data_type': 'DATE',
    ...
    'device_exposure_end_date_outer_substanceadmin_high': {
        'config_type': 'FIELD',
        'data_type': 'DATE',
        'element': "../../../../../hl7:effectiveTime/hl7:high[not(@nullFlavor='UNK')]",
        'attribute': "value",
    ...
    'device_exposure_end_datetime_inner_substanceadmin_high': {
        'config_type': 'FIELD',
    ...
    'device_exposure_end_datetime_outer_substanceadmin_high': {
        'config_type': 'FIELD',
        'data_type': 'DATETIME_HIGH',
        'element': "../../../../../hl7:effectiveTime/hl7:high[not(@nullFlavor='UNK')]",
        'attribute': "value",

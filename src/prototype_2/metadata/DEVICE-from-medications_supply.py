...
#
metadata = {
    'DEVICE-from-medications_supply': {
    'root': {
        'config_type': 'ROOT',
        ...
        'element':
          ("./hl7:component/hl7:structuredBody/hl7:component/hl7:section"
           ...
           "/hl7:supply/hl7:product/hl7:manufacturedProduct/hl7:manufacturedMaterial")
    },
    ...
    'device_exposure_start_date_substanceadmin_low': {
        'config_type': 'FIELD',
        'data_type': 'DATE',
        'element': "../../../../../hl7:effectiveTime/hl7:low",
        'attribute': "value",
    ...
    'device_exposure_start_date_substanceadmin_value': {
        'config_type': 'FIELD',
        'data_type': 'DATE',
    ...
    'device_exposure_end_date_supply_high': {
        'config_type': 'FIELD',
        'data_type': 'DATE',
    ...
    'device_exposure_end_date_substanceadmin_high': {
        'config_type': 'FIELD',
        'data_type': 'DATE',
        'element': "../../../../../hl7:effectiveTime/hl7:high[not(@nullFlavor='UNK')]",
        'attribute': "value",
    ...
    'cfg_name': {
        'config_type': 'CONSTANT',
        'constant_value': 'DEVICE-from-medications_supply',
        'order': 101
    }
}
}

...
def get_ccda_value_set_mapping_table_dataset():
    return ccda_value_set_mapping_table_dataset
...
def get_visit_concept_xwalk_mapping_dataset():
    return visit_concept_xwalk_mapping_dataset
